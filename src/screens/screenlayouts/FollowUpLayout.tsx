...
export default function FollowUpLayout({ children }: LayoutProps) {
  ...
  const navItems = [
    { icon: LayoutDashboardIcon, label: "Dashboard", href: "/follow-up" },
    { icon: UserCircle2Icon, label: "Souls", href: "/follow-up/souls" },
     {
          icon: TrendingUpDown,
          label: "Testimony",
          href: "/follow-up/manage-testimonies",
        },
    {
      icon: Settings,
      label: "User Settings",
      href: "/follow-up/settings",
    },
  ];
